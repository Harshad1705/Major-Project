...
class _SignupInState extends State<SignupIn> {
  MobilVerificationState currentState = MobilVerificationState.SHOW_MOBILE_FORM_STATE;
  ...
  void signInWithPhoneAuthCredential(PhoneAuthCredential phoneAuthCredential) async{
    ...
    await users.doc(phoneController.text).get().then((DocumentSnapshot documentSnapshot){
      ...
      if(authCredential.user != null){
        ...
        Navigator.push(
            context,MaterialPageRoute(builder: (context){
              return hasFirestoreData?const Navigation():Registration(mobile: phoneController.text);
        })
        );
      }
                  ...
                  if(phoneController.text.length >= 10 && phoneController.text.length < 11){
                    ...
                    await _auth.verifyPhoneNumber(
                        ...
                        codeSent: (verificationId, resendingToken) async {
                          setState(() {
                            showLoading = false;
                            currentState = MobilVerificationState.SHOW_OTP_FORM_STATE;
                    ...
                    SnackBar snakBar = const SnackBar(content: Text("Please Enter Valid Number!"));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
          ...
          child: showLoading ? const Center(child: CircularProgressIndicator(),)  :  currentState == MobilVerificationState.SHOW_MOBILE_FORM_STATE
              ? getMobileFormWidget(context)
