...
import 'package:quick_help/Officer/signup_signin_officer.dart';
import 'package:velocity_x/velocity_x.dart';

class StartPageOfficer extends StatefulWidget {
  const StartPageOfficer({Key? key}) : super(key: key);

  @override
  State<StartPageOfficer> createState() => _StartPageOfficerState();
}

class _StartPageOfficerState extends State<StartPageOfficer> {
  ...
  List<String> notations = [
    "Women In Trouble?",
    "Pressed SOS",
    "And You Will Get Instant Notification",
    "Just Accept Request and Help"
  ];
  bool isTapped = false;
  @override
            ...
            Listener(
              ...
              child: AnimatedContainer(
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const SignUpSignInOfficer()));
              }),
            ),
            const Spacer(
              flex: 5,
